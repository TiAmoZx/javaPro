...
import 儿科门诊医生诊疗操作.LoginDemo.B1;
...
public Yuanzhangdeanniu(){
	...
	setVisible(true);
	myButton1=new JButton("科室挂号量和总金额");
	myButton2=new JButton("科室挂号量和总金额(饼图)");
	myButton3=new JButton("各药品库存");
	myButton4=new JButton("各医生就诊数量和金额");
	add(myButton1);
	add(myButton2);
	add(myButton3);
	add(myButton4);
