...
public class Medicine1 extends JFrame {
	...
	public Medicine1() {
		...
		try{
				...
				con=(Connection) DriverManager.getConnection("jdbc:sqlserver://10.20.168.23:1433;DatabaseName=hosptial","sa","sa");
